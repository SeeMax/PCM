...
<section id="<?php echo esc_attr($id); ?>" class="<?php echo esc_attr($className); ?>">
  <div class="content">
    ...
    <div class="hero-carousel-container heroCarouselContainer" id="<?php echo $carouselID;?>">
      <?php if( have_rows('hero_slides') ):?>
        <?php while ( have_rows('hero_slides') ) : the_row();?>
          ...
          <div class="single-hero-carousel" data-postid="<?php echo $p->ID;?>">
            <div class="white-shadow featured-hero-text-half 
              <?php if($addImage == 'yes'):?>
                c-width-55
              <?php else:?>
                c-width-90
            ...
            <?php if($addImage == 'yes'):?>
              <div class="featured-hero-image-half c-width-52">
